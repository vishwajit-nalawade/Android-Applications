                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                            {
                                if(dataSnapshot.exists())
                                {
                                    ...
                                    if(type.equals("received"))
                                    {
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener()
                                        {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                holder.userStatus.setText("Sent you a Connection request");
                                    ...
                                    else if(type.equals("sent"))
                                    {
                                        ...
                                        Button request_cancel = holder.itemView.findViewById(R.id.request_cancel_btn);
                                        request_cancel.setText("Cancel");
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener()
                                        {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                holder.userName.setText(requestUserName);
                                                holder.userStatus.setText("You sent a Connection request to" + requestUserName);
